...
class HistorialClinicoWidget extends StatefulWidget {
  const HistorialClinicoWidget({super.key});

  static String routeName = 'HistorialClinico';
  static String routePath = '/historialClinico';
                          ...
                          child: TabBarView(
                            ...
                            children: [
                              Container(
                                ...
                                child:
                                    StreamBuilder<List<HistorialClinicoRecord>>(
                                  stream: queryHistorialClinicoRecord(),
                                  builder: (context, snapshot) {
                                    ...
                                    List<HistorialClinicoRecord>
                                        listViewHistorialClinicoRecordList =
                                        snapshot.data!;
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewHistorialClinicoRecord =
                                            listViewHistorialClinicoRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0.0),
                                                            child: Text(
                                                              listViewHistorialClinicoRecord
                                                                  .conversado,
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context
                                .pushNamed(NotasConfidencialesWidget.routeName);
                          },
